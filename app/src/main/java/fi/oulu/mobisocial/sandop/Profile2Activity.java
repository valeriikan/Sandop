...
public class Profile2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileContent = (LinearLayout) findViewById(R.id.profileContent1);
        profileLoading = (ProgressBar) findViewById(R.id.profileLoading1);
        tvProfileName = (TextView) findViewById(R.id.tvProfileName1);
        imgProfileBackground = (ImageView) findViewById(R.id.imgProfileBackground1);
        imgProfileBackground.setImageResource(R.drawable.ui_profile_background);
        mainUserpic = (ImageView) findViewById(R.id.profileUserpic1);
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(Profile2Activity.this).load(imageUrl).fit().centerCrop()
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_out) {
            ...
            Intent logout = new Intent(Profile2Activity.this, LoginActivity.class);
